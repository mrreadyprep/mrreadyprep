// The logged-in application: everything a student sees only after signing in (Dashboard, every
// Reading/Listening/Writing/Speaking exercise, Full Mock Test, Vocabulary, Forum, Badges,
// Leaderboard, AI Tutor, Admin Panel, Subscribe/checkout, and every shared helper only those
// screens use). Split out of App.jsx (see the comment there next to `const App = lazy(...)`) so
// an anonymous landing-page visitor's browser never has to download, parse, or execute any of
// this -- it was previously the bulk of a single 697KB JS bundle. Generated by a scripted split
// (dependency-reachability analysis from the `App` component, cut at the AuthGate boundary) --
// if you add a new top-level component/helper here, it only needs to live in this file if
// nothing in App.jsx (LandingPage/AuthScreen/AuthGate) also references it; if both need it, add
